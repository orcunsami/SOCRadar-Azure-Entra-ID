...
BASE_URL = "https://platform.socradar.com/api/company/{company_id}/dark-web-monitoring/pii-exposure/v2"
PAGE_SIZE = 100
...
def fetch(conf: dict, checkpoint: dict) -> list:
    ...
    logger.info("[PII] Starting fetch. start_date=%s, page=1", start_date)
